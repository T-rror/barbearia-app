export default function ConcluidoCard({ agendamento }) {
  ...
  if (agendamento.concludedAt) {
    ...
    concluidoAt = isNaN(concluidoDate)
      ? "Data inválida"
      : concluidoDate.toLocaleString("pt-BR");
  }
  ...
  return (
    <div className="border p-3 rounded mb-2">
      ...
      <p>
        <strong>Data:</strong> {dataFormatada} às {hora}
      </p>
      <p className="text-sm text-gray-500">Concluído em: {concluidoAt}</p>
    </div>
  );
}
